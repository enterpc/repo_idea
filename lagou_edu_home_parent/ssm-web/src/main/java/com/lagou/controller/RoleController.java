...
public class RoleController {
    ...
    */
    ...
    public ResponseResult findResourceListByRoleId(Integer roleId){
        ...
        List<ResourceCategory> RCList = roleService.findResourceListByRoleId(roleId);

        ResponseResult responseResult = new ResponseResult(true, 200, "获取资源信息成功", RCList);
    ...
    public ResponseResult roleContextResource (@RequestBody RoleResourceVo roleResourceVo){
        ...
        ResponseResult responseResult = new ResponseResult(true, 200, "角色分配资源成功", null);
